...
{
  public SlidingCategoryDatasetDemo1(String paramString)
  {
    super(paramString);
  ...
  {
    SlidingCategoryDatasetDemo1 localSlidingCategoryDatasetDemo1 = new SlidingCategoryDatasetDemo1("JFreeChart: SlidingCategoryDatasetDemo1.java");
    localSlidingCategoryDatasetDemo1.pack();
    RefineryUtilities.centerFrameOnScreen(localSlidingCategoryDatasetDemo1);
    localSlidingCategoryDatasetDemo1.setVisible(true);
  }
    ...
    implements ChangeListener
  {
    ...
    private static CategoryDataset createDataset()
    {
      ...
      for (int i = 0; i < 50; ++i)
        localDefaultCategoryDataset.addValue(Math.random() * 100.0D, "S1", "Series " + i);
      return localDefaultCategoryDataset;
    }

    private static JFreeChart createChart(CategoryDataset paramCategoryDataset)
    {
      JFreeChart localJFreeChart = ChartFactory.createBarChart("SlidingCategoryDatasetDemo1", "Series", "Value", paramCategoryDataset, PlotOrientation.HORIZONTAL, false, true, false);
