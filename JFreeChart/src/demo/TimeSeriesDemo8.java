...
{
  public TimeSeriesDemo8(String paramString)
  {
    super(paramString);
  ...
  private static XYDataset createDataset()
  {
    ...
    TimeSeries localTimeSeries2 = MovingAverage.createMovingAverage(localTimeSeries1, "30 day moving average", 30, 30);
  ...
  {
    JFreeChart localJFreeChart = ChartFactory.createTimeSeriesChart("Time Series Demo 8", "Date", "Value", paramXYDataset, true, true, false);
    ...
    StandardXYToolTipGenerator localStandardXYToolTipGenerator = new StandardXYToolTipGenerator("{0}: ({1}, {2})", new SimpleDateFormat("d-MMM-yyyy"), new DecimalFormat("0.00"));
    localXYLineAndShapeRenderer.setBaseToolTipGenerator(localStandardXYToolTipGenerator);
  ...
  {
    TimeSeriesDemo8 localTimeSeriesDemo8 = new TimeSeriesDemo8("Time Series Demo 8");
    localTimeSeriesDemo8.pack();
    RefineryUtilities.centerFrameOnScreen(localTimeSeriesDemo8);
    localTimeSeriesDemo8.setVisible(true);
  }
}