...
public class LineChartDemo7 extends ApplicationFrame
{
  ...
  {
    JFreeChart localJFreeChart = ChartFactory.createLineChart("Line Chart Demo 7", "Category", "Count", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
  ...
  {
    LineChartDemo7 localLineChartDemo7 = new LineChartDemo7("JFreeChart: LineChartDemo7.java");
