...
/*      */ import com.dukascopy.transport.common.msg.datafeed.DFWStateChange;
...
/*  992 */     else if (type.equals("dfw_state_message"))
/*  993 */       result = new DFWStateChange(msg);
/*  994 */     else if (type.equals("user.properties.request"))
/*  995 */       result = new UserPropertiesRequestMessage(msg);
/*  996 */     else if (type.equals("user.properties.response"))
/*  997 */       result = new UserPropertiesResponseMessage(msg);
/*  998 */     else if (type.equals("user.properties.change"))
/*  999 */       result = new UserPropertiesChangeMessage(msg);
/* 1000 */     else if (type.equals("orderGroupsBinaryMessage"))
/* 1001 */       result = new OrderGroupsBinaryMessage(msg);
/* 1002 */     else if (type.equals("task_prog"))
/* 1003 */       result = new TaskProgressMessage(msg);
/* 1004 */     else if (type.equals("feedHistReq"))
/* 1005 */       result = new FeedHistoryRequest(msg);
/* 1006 */     else if (type.equals("blp_swap_subsc"))
/* 1007 */       result = new BloombergSwapSubscribeRequestMessage(msg);
/* 1008 */     else if (type.equals("blp_swap_unsubsc"))
/* 1009 */       result = new BloombergSwapUnsubscribeRequestMessage(msg);
/* 1010 */     else if (type.equals("blp_candle_subsc"))
/* 1011 */       result = new BloombergCandleSubscribeRequestMessage(msg);
/* 1012 */     else if (type.equals("esignal_tm"))
/* 1013 */       result = new ESignalTickMessage(msg);
/* 1014 */     else if (type.equals("df_history_start_request"))
/* 1015 */       result = new DFHistoryStartRequestMessage(msg);
/* 1016 */     else if (type.equals("df_history_start_response"))
/* 1017 */       result = new DFHistoryStartResponseMessage(msg);
/* 1018 */     else if (type.equals("df_weekends_request"))
/* 1019 */       result = new DFWeekendsRequestMessage(msg);
/* 1020 */     else if (type.equals("df_weekends_response"))
/* 1021 */       result = new DFWeekendsResponseMessage(msg);
/* 1022 */     else if (type.equals("accExp"))
/* 1023 */       result = new AccountExposureMessage(msg);
/* 1024 */     else if (type.equals("accInstrExp"))
/* 1025 */       result = new AccountInstrumentExposureMessage(msg);
/* 1026 */     else if (type.equals("expRes"))
/* 1027 */       result = new ExposureReservationMessage(msg);
/* 1028 */     else if (type.equals("api_online"))
/* 1029 */       result = new ApiOnlineMessage(msg);
/* 1030 */     else if (type.equals("tss_message")) {
/* 1031 */       result = new TSSMessage(msg);
/*      */     }
/*      */ 
/* 1037 */     return result;
/*      */   }
...
/*      */   {
/* 1050 */     if (string.indexOf(":\"[") >= 0) {
/* 1051 */       string = string.replace(":\"[", ":[");
/*      */     }
/* 1053 */     if (string.indexOf("]\"") >= 0) {
/* 1054 */       string = string.replace("]\"", "]");
/*      */     }
/* 1056 */     if (string.indexOf("\\\"") >= 0) {
/* 1057 */       string = string.replace("\\\"", "\"");
/*      */     }
/*      */ 
/* 1060 */     return string;
/*      */   }
...
/* 1064 */     return this.properties;
/*      */   }
/*      */ 
/*      */   public void setProperty(String name, Object property) {
/* 1068 */     this.properties.put(name, property);
/*      */   }
/*      */ 
/*      */   public Object getProperty(String name) {
/* 1072 */     return this.properties.get(name);
/*      */   }
/*      */ 
/*      */   public void clearProperty(String name) {
/* 1076 */     this.properties.remove(name);
/*      */   }
/*      */ 
...
/*      */     while (true)
/*      */     {
/* 1095 */       String s = "<script>parent.push({\"hsexUser\":\"false\",\"instrument\":\"EUR/USD\",\"amount\":\"1\",\"priceClient\":\"1.21400\",\"type\":\"order\",\"timeSyncMs\":\"1143736114585\",\"orderId\":\"76548.2\",\"orderGroupId\":\"76548\",\"state\":\"EXECUTING\",\"dir\":\"OPEN\",\"side\":\"BUY\"})</script>";
/*      */ 
/* 1097 */       long startTimeMillis = System.currentTimeMillis();
/*      */ 
/* 1099 */       ProtocolMessage pm = parse(s);
/* 1100 */       System.out.println("pm.toString=" + pm.toProtocolString());
/*      */ 
/* 1102 */       long endTimeMillis = System.currentTimeMillis();
/* 1103 */       System.out.println("Time spent: " + (endTimeMillis - startTimeMillis));
/*      */       try
/*      */       {
/* 1106 */         Thread.sleep(2000L);
...
/* 1114 */     super.clone();
/* 1115 */     return parse(toProtocolString());
/*      */   }
/*      */ }

/* Location:           J:\javaworksvn\JForexClientLibrary_branch\libs\dds2-common-2.3.82.jar
