...
public class DescendingTrianglePatternIndicator extends AbstractPatternIndicator {
    ...
    private double calculatePatternQuality(
        ...
        double additionalPointsQuality = (pointsCount - getMinPatternPivotPointNumber()) * HUNDRED_PERCENT * 0.1;
