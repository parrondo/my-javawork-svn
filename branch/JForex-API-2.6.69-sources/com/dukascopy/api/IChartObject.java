...
public interface IChartObject {
	 ...
	 */
	public static final String PROPERTY_FOREGROUND_COLOR = "color"; //$NON-NLS-1$
	/**
	 * String constant to be used in PropertyChangeListener.
	 */
	public static final String PROPERTY_FOREGROUND_ALPHA = "alpha"; //$NON-NLS-1$
	/**
	 * String constant to be used in PropertyChangeListener.
	 */
	public static final String PROPERTY_STROKE = "stroke"; //$NON-NLS-1$
	/**
	 * String constant to be used in PropertyChangeListener.
	 */
	 ...
	 * String constant to be used in PropertyChangeListener.
	 */
	public static final String PROPERTY_STICKY = "sticky"; //$NON-NLS-1$
	/**
	 * String constant to be used in PropertyChangeListener.
	 * <code>PropertyChangeListener</code> fires <code>IndexedPropertyChangeEvent</code> with index of modified point
	 */
	public static final String PROPERTY_POINT_TIME = "time"; //$NON-NLS-1$
	/**
	 * String constant to be used in PropertyChangeListener.
	 * <code>PropertyChangeListener</code> fires <code>IndexedPropertyChangeEvent</code> with index of modified point
	 */
	public static final String PROPERTY_POINT_PRICE = "price"; //$NON-NLS-1$
