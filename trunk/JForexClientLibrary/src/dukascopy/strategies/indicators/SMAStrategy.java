...
public class SMAStrategy implements IStrategy {
    ...
    public void onBar(Instrument instrument, Period period, IBar askBar, IBar bidBar) throws JFException {
       ...
       filteredSma90 = indicators.sma(instrument, selectedPeriod, OfferSide.BID, AppliedPrice.CLOSE, 24,
                indicatorFilter, 2, prevBar.getTime(), 0);
        filteredSma10 = indicators.sma(instrument, selectedPeriod, OfferSide.BID, AppliedPrice.CLOSE, 7,
                indicatorFilter, 2, prevBar.getTime(), 0);
