...
/*      */     }
/*  123 */     this.currencyConverter = new TesterCurrencyConverter(null);
...
/*      */     try
/*      */     {
/*  292 */       Method method = getClass().getDeclaredMethod("mergeOrdersImpl", new Class[] { TesterOrder.class, [Lcom.dukascopy.api.IOrder.class, TesterReportData.TesterEvent.CloseTrigger.class });
...
/*      */     try {
/*  342 */       Method method = getClass().getDeclaredMethod("mergeOrdersImpl", new Class[] { TesterOrder.class, [Lcom.dukascopy.api.IOrder.class, TesterReportData.TesterEvent.CloseTrigger.class });
...
/*      */       try {
/*  551 */         Method method = getClass().getDeclaredMethod("submitOrderImpl", new Class[] { TesterOrder.class });
/*  552 */         Method addOrderSubmittedReportDataMethod = getClass().getDeclaredMethod("addOrderSubmittedReportData", new Class[] { IOrder.class, Double.TYPE, Double.TYPE });
/*      */ 
...
/*      */     try {
/*  857 */       Method method = getClass().getDeclaredMethod("closeOrderImpl", new Class[] { TesterOrder.class, Double.TYPE, Double.TYPE, Boolean.TYPE, TesterReportData.TesterEvent.CloseTrigger.class });
...
/*      */ 
/*  886 */     if (this.mode.equals(IEngine.StrategyMode.INDEPENDENT))
/*      */       try {
/*  888 */         Method method = getClass().getDeclaredMethod("closeOrderImpl", new Class[] { TesterOrder.class, Double.TYPE, Double.TYPE, Boolean.TYPE, TesterReportData.TesterEvent.CloseTrigger.class });
/*      */ 
...
/*      */ 
/* 1300 */     if (this.mode.equals(IEngine.StrategyMode.INDEPENDENT))
/*      */       try {
/* 1302 */         Method method = getClass().getDeclaredMethod("cancelOrderImpl", new Class[] { TesterOrder.class });
/* 1303 */         Method addOrderCanceledReportDataMethod = getClass().getDeclaredMethod("addOrderCanceledReportData", new Class[] { IOrder.class, TesterReportData.TesterEvent.CloseTrigger.class });
/*      */ 
...
/*      */       try
/*      */       {
/* 1610 */         Method method = getClass().getMethod("changeAmountImpl", new Class[] { TesterOrder.class, Double.TYPE });
/* 1611 */         Method addOrderChangedReportDataMethod = getClass().getDeclaredMethod("addOrderChangedReportData", new Class[] { TesterOrder.class });
...
/*      */     try
/*      */     {
/* 1658 */       Method method = getClass().getMethod("changeOpenPriceImpl", new Class[] { TesterOrder.class, Double.TYPE });
/* 1659 */       Method addOrderChangedReportDataMethod = getClass().getDeclaredMethod("addOrderChangedReportData", new Class[] { TesterOrder.class });
...
/*      */     try
/*      */     {
/* 1698 */       Method method = getClass().getMethod("setStopLossImpl", new Class[] { IOrder.class, Double.TYPE, OfferSide.class, Double.TYPE });
...
/*      */     try
/*      */     {
/* 1731 */       Method method = getClass().getMethod("setTakeProfitImpl", new Class[] { TesterOrder.class, Double.TYPE });
...
/*      */     try
/*      */     {
/* 1770 */       Method method = getClass().getMethod("setGoodTillTimeImpl", new Class[] { TesterOrder.class, Long.TYPE });
/* 1771 */       Method addOrderChangedReportDataMethod = getClass().getDeclaredMethod("addOrderChangedReportData", new Class[] { TesterOrder.class });
...
/* 1834 */       if ((this.activeInstruments[i] == 0) || (orders.isEmpty())) {
/*      */         continue;
/*      */       }
...
/*      */       }
/* 1874 */       else secondaryExposure = placeOffersInSecondaryCCY;
/*      */ 
...
/*      */     }
/* 1968 */     else secondaryExposure = placeOffersInSecondaryCCY;
/*      */ 
...
/*      */       try {
/* 2030 */         if (isWeekends()) { cancelTimedoutPBPOOrders();
/*      */           return; }
...
/*      */       }
/*      */     }
/*      */     try { perfStatTimeStart = this.strategyRunner.perfStartTime();
/*      */       boolean marginCall;
/*      */       try {
...
/*      */         }
/*      */       });
/* 2153 */       for (IOrder aToSort : toSort) {
/* 2154 */         TesterOrder orderToClose = (TesterOrder)aToSort;
/*      */ 
/* 2156 */         double exposureByInstrument = getExposureByInstrument(orderToClose.getInstrument());
/*      */ 
/* 2158 */         if (exposureByInstrument == exposureByInstrument) {
/* 2159 */           double usableDiff = 0.0D;
...
/*      */             }
/*      */           }
/* 2167 */           if (usableDiff >= orderToClose.getAmountInUnits())
/*      */           {
/*      */             continue;
/*      */           }
/*      */         }
...
/*      */     }
/*      */ 
/* 2183 */     double useOfLeverage = StratUtils.roundHalfEven(this.account.getUseOfLeverageActual() / 100.0D, 2);
...
/* 2228 */           double amount = ((Double)entry.getValue()).doubleValue();
/* 2229 */           if ((amount <= 0.0D ? -amount : amount) > 0.0D) {
/* 2230 */             IEngine.OrderCommand orderCommand = amount > 0.0D ? IEngine.OrderCommand.SELL : IEngine.OrderCommand.BUY;
/*      */ 
/* 2232 */             double orderAmount = StratUtils.roundHalfEven(StratUtils.roundHalfEven(amount * removingPart / 1000.0D, 2) * 1000.0D, 2);
/* 2233 */             if (((orderAmount <= 0.0D ? -orderAmount : orderAmount) > (amount <= 0.0D ? -amount : amount)) || (amount <= 100000.0D))
/*      */             {
/* 2235 */               orderAmount = amount;
/* 2236 */             } else if ((orderAmount <= 0.0D ? -orderAmount : orderAmount) < 100000.0D) {
/* 2237 */               orderAmount = 100000.0D;
/*      */             }
/* 2239 */             orderAmount = orderAmount <= 0.0D ? -orderAmount : orderAmount;
/* 2240 */             String message = "Strategy tester: MARGIN CUT: reducing exposure by " + orderAmount;
/* 2241 */             this.notificationUtils.postWarningMessage(message, true);
/* 2242 */             addMCReportData(message, false);
/* 2243 */             IOrder cuttingOrder = submitOrderMC(MC_MARGIN_CUT + "_" + this.margineCutLabelCounter.incrementAndGet(), instrument, orderCommand, StratUtils.roundHalfEven(orderAmount / 1000000.0D, 2));
/* 2244 */             processUserCommands();
/*      */             try {
/* 2246 */               executeConditionally((TesterOrder)cuttingOrder);
/*      */             } catch (Exception e) {
/* 2248 */               LOGGER.error(e.getMessage(), e);
/* 2249 */               TesterMessage testerMessage = new TesterMessage("Unexpected execution error", IMessage.Type.NOTIFICATION, cuttingOrder, this.currentTime);
/* 2250 */               ((TesterOrder)cuttingOrder).update(testerMessage);
/* 2251 */               fireOnMessage(testerMessage);
/*      */             }
/* 2253 */             return true;
/*      */           }
/*      */         }
...
/* 2262 */     TesterReportData.TesterEvent event = new TesterReportData.TesterEvent();
/* 2263 */     if (isMarginCut)
/* 2264 */       event.type = TesterReportData.TesterEvent.EventType.MARGIN_CUT;
/*      */     else {
/* 2266 */       event.type = TesterReportData.TesterEvent.EventType.MARGIN_CALL;
/*      */     }
/* 2268 */     event.time = this.currentTime;
/* 2269 */     event.text = text;
/*      */   }
/*      */ 
/*      */   private void logClientThrowable(Throwable t, IStrategyExceptionHandler.Source source) {
/* 2273 */     LOGGER.error(t.getMessage(), t);
/* 2274 */     StringWriter out = new StringWriter();
/* 2275 */     PrintWriter pw = new PrintWriter(out);
/* 2276 */     t.printStackTrace(pw);
/* 2277 */     String error = StrategyWrapper.representError(this.strategy, t);
/* 2278 */     this.notificationUtils.postErrorMessage("Strategy tester: " + error, t, true);
/* 2279 */     TesterReportData.TesterEvent event = new TesterReportData.TesterEvent();
/* 2280 */     event.type = TesterReportData.TesterEvent.EventType.EXCEPTION;
/* 2281 */     event.time = this.currentTime;
/* 2282 */     event.text = error;
/* 2283 */     this.testerReportData.addEvent(event);
/* 2284 */     this.exceptionHandler.onException(1L, source, t);
/*      */   }
/*      */ 
/*      */   public synchronized long getCurrentTime() {
/* 2288 */     return this.currentTime;
/*      */   }
/*      */ 
/*      */   public String getAccount() {
/* 2292 */     return "tester_account";
/*      */   }
/*      */ 
...
/*      */   {
/* 2302 */     if (orderId == null) {
/* 2303 */       throw new NullPointerException("OrderId is null");
/*      */     }
/* 2305 */     for (TesterOrder order : this.allOrders) {
/* 2306 */       if (order.getId().equals(orderId)) {
/* 2307 */         return order;
/*      */       }
/*      */     }
/* 2310 */     return null;
...
/*      */     try {
/* 2315 */       AccessController.doPrivileged(new PrivilegedExceptionAction(order, timeout, unit) {
/*      */         public Object run() throws Exception {
/* 2317 */           if ((this.val$order.getState() != IOrder.State.CLOSED) && (this.val$order.getState() != IOrder.State.CANCELED)) {
/* 2318 */             TesterCustodian.this.strategyRunner.runUntilChange(this.val$order, this.val$timeout, this.val$unit);
/*      */           }
/* 2320 */           return null;
/*      */         } } );
/*      */     } catch (PrivilegedActionException e) {
/* 2324 */       LOGGER.error(e.getMessage(), e);
/* 2325 */       if (e.getCause() == null)
/* 2326 */         logClientThrowable(e, null);
/*      */       else
/* 2328 */         logClientThrowable(e.getCause(), null);
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/*      */     try {
/* 2335 */       AccessController.doPrivileged(new PrivilegedExceptionAction(order, timeout, unit, expectedStates) {
/*      */         public Object run() throws Exception {
/* 2337 */           if ((this.val$order.getState() != IOrder.State.CLOSED) && (this.val$order.getState() != IOrder.State.CANCELED)) {
/* 2338 */             TesterCustodian.this.strategyRunner.runUntilChange(this.val$order, this.val$timeout, this.val$unit, this.val$expectedStates);
/*      */           }
/* 2340 */           return null;
/*      */         } } );
/*      */     } catch (PrivilegedActionException e) {
/* 2344 */       LOGGER.error(e.getMessage(), e);
/* 2345 */       if (e.getCause() == null)
/* 2346 */         logClientThrowable(e, null);
/*      */       else
/* 2348 */         logClientThrowable(e.getCause(), null);
/*      */     }
/*      */   }
/*      */ 
/*      */   public boolean isStrategyThread()
/*      */   {
/* 2354 */     return this.strategyRunner.isStrategyThread();
/*      */   }
/*      */ 
/*      */   ITick getLastTick(Instrument instrument) {
/* 2358 */     return this.lastTicks[instrument.ordinal()];
/*      */   }
/*      */ 
/*      */   AbstractCurrencyConverter getCurrencyConverter() {
/* 2362 */     return this.currencyConverter;
/*      */   }
/*      */ 
...
/* 2370 */     long perfStatTimeStart = this.strategyRunner.perfStartTime();
/* 2371 */     StrategyEventsListener strategyEventsListener = this.strategyRunner.getStrategyEventsListener();
/*      */     try {
/* 2373 */       this.strategy.onMessage(message);
/* 2374 */       if (strategyEventsListener != null)
/* 2375 */         strategyEventsListener.onMessage(message);
/*      */     }
/*      */     catch (Throwable t)
/*      */     {
/* 2379 */       logClientThrowable(t, IStrategyExceptionHandler.Source.ON_MESSAGE);
/*      */     } finally {
/* 2381 */       this.strategyRunner.perfStopTime(perfStatTimeStart, ITesterReport.PerfStats.ON_MESSAGE);
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/* 2427 */     if (this.signalsProcessor != null)
/* 2428 */       this.signalsProcessor.add(new SignalImpl(order, type));
/*      */   }
/*      */ 
/*      */   public ISignalsProcessor getSignalsProcessor()
/*      */   {
/* 2433 */     return this.signalsProcessor;
/*      */   }
/*      */ 
/*      */   public TesterOrdersProvider getTesterOrdersProvider() {
/* 2437 */     return this.testerOrdersProvider;
/*      */   }
/*      */ 
/*      */   public IStrategyRunner getStrategyRunner() {
/* 2441 */     return this.strategyRunner;
/*      */   }
/*      */ 
/*      */   public void setSignalsProcessor(ISignalsProcessor signalsProcessor) {
/* 2445 */     this.signalsProcessor = signalsProcessor;
/*      */   }
/*      */ 
/*      */   static
/*      */   {
...
/*      */     {
/* 2388 */       ITick tick = TesterCustodian.this.lastTicks[instrument.ordinal()];
/* 2389 */       if (tick == null) {
/* 2390 */         throw new IllegalStateException("No market state found for currency pair: " + instrument);
/*      */       }
/* 2392 */       if (side == OfferSide.BID)
/* 2393 */         return tick.getBid();
/* 2394 */       if (side == OfferSide.ASK) {
/* 2395 */         return tick.getAsk();
/*      */       }
/* 2397 */       return StratUtils.roundHalfEven((tick.getBid() + tick.getAsk()) / 2.0D, 7);
/*      */     }
/*      */   }
/*      */ }
