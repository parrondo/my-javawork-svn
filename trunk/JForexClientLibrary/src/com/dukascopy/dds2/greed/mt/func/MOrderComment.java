...
/*    */ 
/*    */ public class MOrderComment extends AgentBase.CommonExecution
/*    */ {
/* 13 */   private static Logger log = LoggerFactory.getLogger(MOrderComment.class);
/*    */ 
...
/* 20 */     if (msg != null) {
/* 21 */       returnValue = msg.getOpeningOrder().getTag();
 ...
 * Qualified Name:     com.dukascopy.dds2.greed.mt.func.MOrderComment
