...
/*     */ 
/*     */ public class TickBarDrawingStrategyFactory extends AbstractDrawingStrategyFactory<TickBarDataSequence, TickBarData>
/*     */ {
/*     */   public TickBarDrawingStrategyFactory(ChartState chartState, MouseControllerMetaDrawingsState mouseControllerMetaDrawingsState, FormattersManager formattersManager, GeometryCalculator geometryCalculator, ITimeToXMapper timeToXMapper, IValueToYMapper valueToYMapper, SubValueToYMapper subValueToYMapper, OrdersDrawingManager ordersDrawingManager, AbstractDataSequenceProvider<TickBarDataSequence, TickBarData> dataSequenceProvider, PathHelper pathHelper, DrawingsLabelHelperContainer drawingsLabelHelperContainer)
/*     */   {
...
/*     */   {
/*  97 */     return new MainAxisYPanelMovableLabelDrawingStrategyTickBar(this.chartState, this.formattersManager.getValueFormatter(), this.valueToYMapper, this.dataSequenceProvider);
/*     */   }
/*     */ 
...
/*     */   {
/* 160 */     return new TickBarRawDataStrategy(this.chartState, new TickBarAsBarVisualisationDrawingStrategy(this.formattersManager.getDateFormatter(), this.chartState, this.dataSequenceProvider, this.geometryCalculator, this.timeToXMapper, this.valueToYMapper, this.pathHelper), new TickBarAsCandleVisualisationDrawingStrategy(this.formattersManager.getDateFormatter(), this.chartState, this.dataSequenceProvider, this.geometryCalculator, this.timeToXMapper, this.valueToYMapper, this.pathHelper));
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.dukascopy.charts.view.drawingstrategies.nticksbar.TickBarDrawingStrategyFactory
