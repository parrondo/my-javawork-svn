...
/*      */     }
/*      */   }
/*  173 */   private String getAuthServers(String jnlp) throws Exception { URL jnlpUrl = new URL(jnlp);
/*      */ 
...
/*  232 */       return;
/*      */     }
/*  234 */     String version = getClass().getPackage().getImplementationVersion();
/*  235 */     if (version == null) {
...
/*      */   }
/*      */ 
/*      */   public synchronized void setStrategyEventsListener(StrategyEventsListener strategyEventsListener) {
/*  350 */     for (StrategyStuff strategyStuff : this.strategies.values())
/*  351 */       strategyStuff.strategyRunner.addStrategyEventsListener(strategyEventsListener);
/*      */   }
/*      */ 
...
/* 1462 */       this.executionControl = executionControl;
/*      */     }
/*      */ 
...
/*      */     private boolean eventLogEnabled;
/*      */ 
/*      */     public TesterLoadingProgressListener(TesterClientImpl.StrategyStuff strategy, com.dukascopy.api.LoadingProgressListener testerProgressListener, Currency accountCurrency, boolean eventLogEnabled)
/*      */     {
/* 1385 */       this.accountCurrency = accountCurrency;
/* 1386 */       this.eventLogEnabled = eventLogEnabled;
/* 1387 */       this.strategy = strategy;
/* 1388 */       this.testerProgressListener = testerProgressListener;
/*      */     }
/*      */ 
/*      */     public TesterLoadingProgressListener(TesterClientImpl.StrategyStuff strategy, com.dukascopy.api.LoadingProgressListener testerProgressListener, TesterClientImpl.TesterExecutionControl testerExecutionControl, Currency accountCurrency, boolean eventLogEnabled)
/*      */     {
/* 1393 */       this.accountCurrency = accountCurrency;
/* 1394 */       this.eventLogEnabled = eventLogEnabled;
/* 1395 */       this.strategy = strategy;
/* 1396 */       this.testerProgressListener = testerProgressListener;
/* 1397 */       this.testerExecutionControl = testerExecutionControl;
/*      */     }
/*      */ 
/*      */     public void dataLoaded(long startTime, long endTime, long currentTime, String information)
/*      */     {
