...
//	}
    ...
    public boolean checkEmergingPatternPostTrend(
        ...
        boolean check = checkCandlePostTrendIsUnderUpperAsymptote(sourceData, dirtyPatternStartIndex, dirtyPatternSize, patternPoints, upperAsymptotePoints);
        check &= checkCandlePostTrendIsOverBottomAsymptote(sourceData, dirtyPatternStartIndex, dirtyPatternSize, patternPoints, bottomAsymptotePoints);
        return check;
    }
