...
import com.dukascopy.api.indicators.OutputParameterInfo;
	 ...
	 *
	 */
	public class APOscillator implements IIndicator {
	    ...
	    public void onStart(IIndicatorContext context) {		    	
	        ...
	        indicatorInfo = new IndicatorInfo("APO", "APO", "Momentum Indicators", false, false, true, 1, 3, 1);
	    ...
	    public IndicatorResult calculate(int startIndex, int endIndex) {	    		      	        	
	        ...
	        for(i = 0, j = slowRes.getFirstValueIndex() - fastRes.getFirstValueIndex(); i < slowRes.getNumberOfElements(); i++, j++){
	        	outputs[0][i] = firstMAOutput[j] - secondMAOutput[i];
	    	}	        
