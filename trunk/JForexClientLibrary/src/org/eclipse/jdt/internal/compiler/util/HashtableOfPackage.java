...
/*     */   }
/*     */   private void rehash() {
/*  84 */     HashtableOfPackage newHashtable = new HashtableOfPackage(this.elementSize * 2);
/*     */ 
...
/*     */     {
/*     */       PackageBinding pkg;
/* 101 */       if ((pkg = this.valueTable[i]) != null)
/* 102 */         s = s + pkg.toString() + "\n"; 
/*     */     }
/* 103 */     return s;
/*     */   }
/*     */ }
 ...
 * Qualified Name:     org.eclipse.jdt.internal.compiler.util.HashtableOfPackage
