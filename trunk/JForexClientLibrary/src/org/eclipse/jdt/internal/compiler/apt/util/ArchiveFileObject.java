...
/* 151 */     return archiveFileObject.toUri().equals(toUri());
/*     */   }
/*     */ 
/*     */   public CharSequence getCharContent(boolean ignoreEncodingErrors)
/*     */     throws IOException
/*     */   {
/* 158 */     if (getKind() == JavaFileObject.Kind.SOURCE) {
...
/*     */   {
/* 168 */     return this.zipEntry.getTime();
/*     */   }
/*     */ 
...
/*     */     try
/*     */     {
/* 211 */       return new URI("jar:" + this.file.toURI().getPath() + "!" + this.zipEntry.getName()); } catch (URISyntaxException localURISyntaxException) {
/*     */     }
/* 213 */     return null;
/*     */   }
/*     */ 
...
/*     */   {
/* 220 */     return this.file.getAbsolutePath() + "[" + this.zipEntry.getName() + "]";
/*     */   }
/*     */ }

/* Location:           G:\javawork\JForexClientLibrary\libs\ecj-3.5.2.jar
 * Qualified Name:     org.eclipse.jdt.internal.compiler.apt.util.ArchiveFileObject
