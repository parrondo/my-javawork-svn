...
/*     */ 
/*  71 */       int length = unitSource.length;
/*  72 */       for (int begin = startPosition >= length ? length - 1 : startPosition; begin > 0; begin--)
/*     */       {
/*     */         char c;
/*  73 */         if (((c = unitSource[(begin - 1)]) == '\n') || (c == '\r')) break;
/*     */       }
/*  75 */       for (int end = endPosition >= length ? length - 1 : endPosition; end + 1 < length; end++)
/*     */       {
/*     */         char c;
 ...
 * Qualified Name:     org.eclipse.jdt.internal.compiler.apt.util.Util
