...
/*  77 */       return -1;
/*     */     }
/*  79 */     return this.target.bytes[(this.target.offset + this.upto - 1)] & 0xFF;
/*     */   }
/*     */ 
/*     */   protected int getCurrentLabel()
/*     */   {
/*  86 */     return this.current.bytes[this.upto] & 0xFF;
/*     */   }
/*     */ 
/*     */   protected void setCurrentLabel(int label)
/*     */   {
/*  91 */     this.current.bytes[this.upto] = (byte)label;
/*     */   }
/*     */ 
/*     */   protected void grow()
/*     */   {
 ...
 * Qualified Name:     org.apache.lucene.util.fst.BytesRefFSTEnum
