...
public class HighLowChartDemo1 extends ApplicationFrame
{
  ...
  public HighLowChartDemo1(String paramString)
  {
    super(paramString);
  ...
  {
    JFreeChart localJFreeChart = ChartFactory.createHighLowChart("High-Low-Open-Close Demo", "Time", "Price", paramOHLCDataset, true);
  ...
  {
    HighLowChartDemo1 localHighLowChartDemo1 = new HighLowChartDemo1("JFreeChart: HighLowChartDemo1.java");
    localHighLowChartDemo1.pack();
    RefineryUtilities.centerFrameOnScreen(localHighLowChartDemo1);
    localHighLowChartDemo1.setVisible(true);
  }
}