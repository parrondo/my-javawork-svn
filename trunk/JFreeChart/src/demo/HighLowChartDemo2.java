...
public class HighLowChartDemo2 extends ApplicationFrame
{
  ...
  public HighLowChartDemo2(String paramString)
  {
    super(paramString);
  ...
  {
    JFreeChart localJFreeChart = ChartFactory.createHighLowChart("HighLowChartDemo2", "Time", "Value", paramOHLCDataset, true);
    ...
    XYDataset localXYDataset = MovingAverage.createMovingAverage(paramOHLCDataset, "-MAVG", 259200000L, 0L);
    localXYPlot.setDataset(1, localXYDataset);
    localXYPlot.setRenderer(1, new StandardXYItemRenderer());
  ...
  {
    HighLowChartDemo2 localHighLowChartDemo2 = new HighLowChartDemo2("JFreeChart: HighLowChartDemo2.java");
    localHighLowChartDemo2.pack();
    RefineryUtilities.centerFrameOnScreen(localHighLowChartDemo2);
    localHighLowChartDemo2.setVisible(true);
  }
}