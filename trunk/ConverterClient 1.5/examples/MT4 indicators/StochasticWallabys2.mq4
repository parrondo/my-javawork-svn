...
//|                              http://www.piptopia.com/tribe/ttega |
//+------------------------------------------------------------------+
...
int start()
{
  ...
  for (int i = 0; i < barsNeeded; i++)
  {
    ...
    //Print(i + " shift1="+shift1 + " shift2="+shift2 + " shift3="+shift3 );
  }
